export default function Footer() {
    return (
      <footer className="bg-gray-100 text-black py-6 px-6 mt-20">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="text-center md:text-left">
            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/d2/Grammarly_logo.svg/1200px-Grammarly_logo.svg.png" className="w-40 " />
            
          </div>
  
          <div className="flex gap-4 text-black">
            <a href="#" aria-label="Facebook" className="hover:text-green-800 transition">
            ...
            <a href="#" aria-label="Twitter" className="hover:text-green-800 transition">
              <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
            ...
            <a href="#" aria-label="Instagram" className="hover:text-green-800 transition">
              <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
        ...
        <div className="mt-6 text-center text-black text-xs">
          &copy; {new Date().getFullYear()} Grammarly - Todos os direitos reservados.
        </div>
      </footer>
    )
  }
